...
func InitOptionMap() {
	...
	common.OptionMap["DefaultProxyTestURL"] = common.DefaultProxyTestURL
	...
	common.OptionMap["GroupModelImageOnly"] = ratio_setting.GroupModelImageOnly2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "DefaultProxyTestURL":
		common.DefaultProxyTestURL = value
	case "ServerAddress":
	...
	case "GroupModelImageOnly":
		err = ratio_setting.UpdateGroupModelImageOnlyByJSONString(value)
