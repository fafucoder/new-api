...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		logRoute.POST("/recalculate_channel_cost", middleware.AdminAuth(), controller.RecalculateChannelCost)
		...
		dataRoute.GET("/cache", middleware.AdminAuth(), controller.GetCacheQuotaDates)
		dataRoute.GET("/channel_cost", middleware.AdminAuth(), controller.GetChannelCostDates)
