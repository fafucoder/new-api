...
import { tryParseVideoPricingConfig } from './videoPricing';
              ...
              <div>
                <div className='mb-4'>
                  ...
                  <RadioGroup
                    type='button'
                    value={
                      selectedModel.editorType || selectedModel.billingMode
                    }
                    onChange={(event) =>
                  ...
                  >
                    ...
                    <Radio value='video'>{t('视频定价')}</Radio>
                ...
                {selectedModel.billingMode === 'per-request' ? (
                  ...
                  <TieredPricingEditor
                    videoOnly={selectedModel.editorType === 'video'}
                    model={selectedModel}
